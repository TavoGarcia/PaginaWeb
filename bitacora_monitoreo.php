    ...
    <div class="contact">
        <div class="container">
            <div class="contact-heading"><br><br>
                <h2 class="wow fadeInDown animated" data-wow-delay=".5s">Bitácora de Monitoreo</h2>
...
?>
                    <?php 
   $query = "SELECT * from bitacora_monitoreo"; 
  if(isset($_POST['buscar'])){
      ...
      if(empty($buscar)){
        $query = "SELECT * from bitacora_monitoreo"; 
          ...
          $query="SELECT * from bitacora_monitoreo
          WHERE usuario like '%$buscar%' or descripcion like '%$buscar%' or fecha like '%$buscar%' ";
